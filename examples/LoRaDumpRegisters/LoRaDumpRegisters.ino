 ...
 **************************************************
 *
 * @file        LoRaDumpRegisters.ino
 * @brief       This examples shows how to inspect and output the LoRa radio's
...
void setup()
{
  ...
  LoRa.dumpRegisters(Serial);	//Print all registers to Serial monitor
}
