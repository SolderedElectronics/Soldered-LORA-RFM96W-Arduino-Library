 ...
 * 5. Copy the generated DevEUI and AppKey here below
 * 6. Open the created end device and copy the AppAUI as well
 * 7. Connect your Dasduiuno board to the breakout according to the diagrams here
 * 8. Upload the sketch and check if your device is sending data to TTN.
 *
 */
