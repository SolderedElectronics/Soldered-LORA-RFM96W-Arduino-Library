...
#define LMIC_C_ASSERT(e) void LMIC_C_ASSERT__(int LMIC_C_ASSERT_x[(e) ? 1 : -1])
#endif
...
#define LMIC_UNREFERENCED_PARAMETER(v)                                                                                 \
    do                                                                                                                 \
    {                                                                                                                  \
        (void)(v);                                                                                                     \
    } while (0)
...
#define LMIC_UNREFERENCED_VARIABLE(v)                                                                                  \
    do                                                                                                                 \
    {                                                                                                                  \
        (void)(v);                                                                                                     \
    } while (0)
...
#define LMIC_DEBUG1_PARAMETER(v)                                                                                       \
    do                                                                                                                 \
    {                                                                                                                  \
        ;                                                                                                              \
    } while (0)
...
#define LMIC_DEBUG2_PARAMETER(v)                                                                                       \
    do                                                                                                                 \
    {                                                                                                                  \
        ;                                                                                                              \
    } while (0)
...
#define LMIC_X_DEBUG_PARAMETER(v)                                                                                      \
    do                                                                                                                 \
    {                                                                                                                  \
        ;                                                                                                              \
    } while (0)
...
#if LMIC_X_DEBUG_LEVEL > 0
#define LMIC_X_DEBUG_VARIABLE(v)                                                                                       \
    do                                                                                                                 \
    {                                                                                                                  \
        ;                                                                                                              \
    } while (0)
