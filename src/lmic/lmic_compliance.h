...
#include <stdint.h>
    ...
    static inline bool lmic_compliance_state_IsActive(lmic_compliance_state_t s)
    {
...
#define LMIC_COMPLIANCE_FSMSTATE__NAMES                                                                                \
    "INITIAL", "NOCHANGE", "ACTIVE", "INACTIVE", "TESTMODE", "ECHOING", "REPORTING", "RECOVERY", "TXBUSY"
