...
#elif defined(AS_923)
static const PROGMEM unsigned char LoRa_Frequency[9][3] = {
    //[923.2 - 924.8] MHz
    {0xE6, 0xCC, 0xF4}, // Channel [0], 923.2 MHz / 61.035 Hz = 15125748 = 0xE6CCF4
    {0xE6, 0xD9, 0xC0}, // Channel [1], 923.4 MHz / 61.035 Hz = 15129024 = 0xE6D9C0
    {0xE6, 0xE6, 0x8D}, // Channel [2], 923.6 MHz / 61.035 Hz = 15132301 = 0xE6E68D
...
static const PROGMEM unsigned char LoRa_Frequency[8][3] = {
    //[921.4 - 922.8] MHz
...
static void RFM_change_SF_BW(unsigned char _SF, unsigned char _BW)
{
    ...
    if (_SF > 10)
        ...
        RFM_Write(RFM_REG_MODEM_CONFIG3,
                  0b0100); // Mobile node, low datarate optimization on AGC acorging to register LnaGain
#else
    RFM_Write(RFM_REG_MODEM_CONFIG3,
              0b0100); // Mobile node, low datarate optimization on AGC acorging to register LnaGain
#endif
