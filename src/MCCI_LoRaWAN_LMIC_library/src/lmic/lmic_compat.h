...
#define LMIC_REGION_au921                                                                                              \
    LMIC_DEPRECATE(GCC warning "LMIC_REGION_au921 is deprecated, EOL at V5, use LMIC_REGION_au915")                    \
    LMIC_REGION_au915
...
#define AU921_125kHz_UPFBASE                                                                                           \
    LMIC_DEPRECATE(GCC warning "A921 symbols are deprecated EOL V5, use AU915") AU915_125kHz_UPFBASE
#define AU921_125kHz_UPFSTEP                                                                                           \
    LMIC_DEPRECATE(GCC warning "A921 symbols are deprecated EOL V5, use AU915") AU915_125kHz_UPFSTEP
#define AU921_500kHz_UPFBASE                                                                                           \
    LMIC_DEPRECATE(GCC warning "A921 symbols are deprecated EOL V5, use AU915") AU915_500kHz_UPFBASE
#define AU921_500kHz_UPFSTEP                                                                                           \
    LMIC_DEPRECATE(GCC warning "A921 symbols are deprecated EOL V5, use AU915") AU915_500kHz_UPFSTEP
#define AU921_500kHz_DNFBASE                                                                                           \
    LMIC_DEPRECATE(GCC warning "A921 symbols are deprecated EOL V5, use AU915") AU915_500kHz_DNFBASE
#define AU921_500kHz_DNFSTEP                                                                                           \
    LMIC_DEPRECATE(GCC warning "A921 symbols are deprecated EOL V5, use AU915") AU915_500kHz_DNFSTEP
...
#define AU921_TX_EIRP_MAX_DBM                                                                                          \
    LMIC_DEPRECATE(GCC warning "A921 symbols are deprecated EOL V5, use AU915") AU915_TX_EIRP_MAX_DBM
#define AU921_INITIAL_TxParam_UplinkDwellTime                                                                          \
    LMIC_DEPRECATE(GCC warning "A921 symbols are deprecated EOL V5, use AU915") AU915_INITIAL_TxParam_UplinkDwellTime
#define AU921_UPLINK_DWELL_TIME_osticks                                                                                \
    LMIC_DEPRECATE(GCC warning "A921 symbols are deprecated EOL V5, use AU915") AU915_UPLINK_DWELL_TIME_osticks
#define DR_PAGE_AU921 LMIC_DEPRECATE(GCC warning "A921 symbols are deprecated EOL V5, use AU915") DR_PAGE_AU915
#define AU921_LMIC_REGION_EIRP                                                                                         \
    LMIC_DEPRECATE(GCC warning "A921 symbols are deprecated EOL V5, use AU915") AU915_LMIC_REGION_EIRP
#endif
