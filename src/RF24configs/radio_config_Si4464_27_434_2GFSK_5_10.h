...
// INPUT DATA
/*
// Crys_freq(Hz): 27000000    Crys_tol(ppm): 20    IF_mode: 2    High_perf_Ch_Fil: 1    OSRtune: 0    Ch_Fil_Bw_AFC: 0
ANT_DIV: 0    PM_pattern: 0
// MOD_type: 3    Rsymb(sps): 5000    Fdev(Hz): 10000    RXBW(Hz): 150000    Manchester: 0    AFC_en: 0    Rsymb_error:
0.0    Chip-Version: 3
...
// Descriptions:
//   INT_CTL_ENABLE - This property provides for global enabling of the three interrupt groups (Chip, Modem and Packet
Handler) in order to generate HW interrupts at the NIRQ pin.
//   INT_CTL_PH_ENABLE - Enable individual interrupt sources within the Packet Handler Interrupt Group to generate a HW
interrupt on the NIRQ output pin.
*/
...
//   MODEM_TX_NCO_MODE_3 - TX Gaussian filter oversampling ratio and Byte 3 of unsigned 26-bit TX Numerically Controlled
Oscillator (NCO) modulus.
//   MODEM_TX_NCO_MODE_2 - TX Gaussian filter oversampling ratio and Byte 3 of unsigned 26-bit TX Numerically Controlled
Oscillator (NCO) modulus.
//   MODEM_TX_NCO_MODE_1 - TX Gaussian filter oversampling ratio and Byte 3 of unsigned 26-bit TX Numerically Controlled
Oscillator (NCO) modulus.
//   MODEM_TX_NCO_MODE_0 - TX Gaussian filter oversampling ratio and Byte 3 of unsigned 26-bit TX Numerically Controlled
Oscillator (NCO) modulus.
//   MODEM_FREQ_DEV_2 - 17-bit unsigned TX frequency deviation word.
//   MODEM_FREQ_DEV_1 - 17-bit unsigned TX frequency deviation word.
*/
#define RF_MODEM_MOD_TYPE_12                                                                                           \
    0x11, 0x20, 0x0C, 0x00, 0x03, 0x00, 0x07, 0x03, 0x0D, 0x40, 0x05, 0x9B, 0xFC, 0xC0, 0x00, 0x03
...
//   MODEM_DECIMATION_CFG0 - Specifies miscellaneous parameters and decimator ratios for the Cascaded Integrator Comb
(CIC) filter.
*/
...
//   MODEM_AFC_GAIN_1 - Sets the gain of the PLL-based AFC acquisition loop, and provides miscellaneous control bits for
AFC functionality.
//   MODEM_AFC_GAIN_0 - Sets the gain of the PLL-based AFC acquisition loop, and provides miscellaneous control bits for
AFC functionality.
...
//   MODEM_OOK_MISC - Selects the detector(s) used for demodulation of an OOK signal, or for demodulation of a (G)FSK
...
//   SYNTH_VCO_KV - Gain scaling factors (Kv) for the VCO tuning varactors on both the integrated-path and feed forward
path.
...
//   FREQ_CONTROL_W_SIZE - Set window gating period (in number of crystal reference clock cycles) for counting VCO
...
#define RADIO_CONFIGURATION_DATA_ARRAY                                                                                 \
    {                                                                                                                  \
        0x07, RF_POWER_UP, 0x08, RF_GPIO_PIN_CFG, 0x06, RF_GLOBAL_XO_TUNE_2, 0x05, RF_GLOBAL_CONFIG_1, 0x06,           \
            RF_INT_CTL_ENABLE_2, 0x08, RF_FRR_CTL_A_MODE_4, 0x05, RF_PREAMBLE_TX_LENGTH_1, 0x05, RF_PREAMBLE_CONFIG_1, \
            0x07, RF_SYNC_CONFIG_3, 0x05, RF_PKT_CONFIG1_1, 0x05, RF_PKT_FIELD_1_CONFIG_1, 0x10, RF_MODEM_MOD_TYPE_12, \
            0x05, RF_MODEM_FREQ_DEV_0_1, 0x0C, RF_MODEM_TX_RAMP_DELAY_8, 0x0D, RF_MODEM_BCR_OSR_1_9, 0x0B,             \
            RF_MODEM_AFC_GEAR_7, 0x05, RF_MODEM_AGC_CONTROL_1, 0x0D, RF_MODEM_AGC_WINDOW_SIZE_9, 0x0C,                 \
            RF_MODEM_OOK_CNT1_8, 0x05, RF_MODEM_RSSI_COMP_1, 0x05, RF_MODEM_CLKGEN_BAND_1, 0x10,                       \
            RF_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12, 0x10, RF_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12, 0x10,                   \
            RF_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12, 0x08, RF_PA_MODE_4, 0x0B, RF_SYNTH_PFDCP_CPFF_7, 0x0C,               \
            RF_FREQ_CONTROL_INTE_8, 0x00                                                                               \
    }
#else
#define RADIO_CONFIGURATION_DATA_ARRAY                                                                                 \
    {                                                                                                                  \
...
#define RADIO_CONFIGURATION_DATA                                                                                       \
    {                                                                                                                  \
        Radio_Configuration_Data_Array, RADIO_CONFIGURATION_DATA_CHANNEL_NUMBER,                                       \
            RADIO_CONFIGURATION_DATA_RADIO_PACKET_LENGTH, RADIO_CONFIGURATION_DATA_RADIO_STATE_AFTER_POWER_UP,         \
