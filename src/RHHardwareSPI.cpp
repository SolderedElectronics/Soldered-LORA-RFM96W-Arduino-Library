...
void RHHardwareSPI::begin()
{
    ...
    defined(ARDUINO_ARCH_NRF52) || defined(ARDUINO_ARCH_STM32) || defined(ARDUINO_ARCH_STM32L0) || defined(NRF52) ||   \
...
//   ::BitOrder bitOrder;
    ...
    (RH_PLATFORM == RH_PLATFORM_CHIPKIT_CORE || RH_PLATFORM == RH_PLATFORM_NRF52)
    uint8_t dataMode;
    if (_dataMode == DataMode0)
        dataMode = SPI_MODE0;
    else if (_dataMode == DataMode1)
...
#if ((RH_PLATFORM == RH_PLATFORM_ARDUINO) && defined(__arm__) &&                                                       \
     (defined(ARDUINO_SAM_DUE) || defined(ARDUINO_ARCH_SAMD))) ||                                                      \
    defined(ARDUINO_ARCH_NRF52) || defined(ARDUINO_ARCH_STM32) || defined(ARDUINO_ARCH_STM32F4) ||                     \
