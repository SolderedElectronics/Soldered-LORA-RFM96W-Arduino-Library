...
class RHEncryptedDriver : public RHGenericDriver
{
  public:
    ...
    {
        return _driver.isChannelActive();
    };
    ...
    {
        _driver.setPromiscuous(promiscuous);
    };
