...
#if defined(ARDUINO_MCCI_CATENA_4420) || /* legacy names */                                                            \
...
static const HalPinmap_t myPinmap = {.nss = HalConfiguration_Catena4420_t::PIN_SX1276_NSS, // chip select is D7
                                     ...
                                     .dio =
                                         {
                                             HalConfiguration_Catena4420_t::PIN_SX1276_DIO0, // DIO0 (IRQ) is D25
