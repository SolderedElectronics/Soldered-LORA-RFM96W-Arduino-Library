...
#if defined(ARDUINO_MCCI_CATENA_4802) || /* legacy names */                                                            \
...
class HalConfiguration_Catena4802_t : public HalConfiguration_t
{
  public:
    ...
    virtual bool queryUsingTcxo(void) override
    {
        return true;
    };
...
static const HalPinmap_t myPinmap = {.nss = HalConfiguration_Catena4802_t::PIN_SX1276_NSS, // chip select is D7
                                     ...
                                     .dio =
                                         {
                                             HalConfiguration_Catena4802_t::PIN_SX1276_DIO0, // DIO0 (IRQ) is D25
