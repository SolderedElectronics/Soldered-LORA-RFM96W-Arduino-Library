...
void RH_RF95::handleInterrupt()
{
    ...
    // at the _beginning_ of the ISR.  If any interrupts occur while handling the ISR, the signal will remain asserted
    // and our ISR will be reinvoked to handle that case) kevinh: turn this off until root cause is known, because it
    // can cause missed interrupts! spiWrite(RH_RF95_REG_12_IRQ_FLAGS, 0xff); // Clear all IRQ flags
...
bool RH_RF95::printRegisters()
{
    ...
    uint8_t registers[] = {0x01, 0x06, 0x07, 0x08,  0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x10,
                           ...
                           0x1d, 0x1e, 0x1f, 0x20,  0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x4b};
...
void RH_RF95::setLowDatarate()
{
    ...
    // or  motion,the  low  data  rate optimization  bit  is  used. Specifically for 125  kHz  bandwidth  and  SF  =  11
    // and  12, this  adds  a  small  overhead  to increase robustness to reference frequency variations over the
    // timescale of the LoRa packet."
