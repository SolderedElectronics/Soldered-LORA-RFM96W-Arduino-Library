...
class RH_RF95 : public RHSPIDriver
{
  public:
    ...
    /// accessing it. Defaults to the normal SS pin for your Arduino (D10 for Diecimila, Uno etc, D53 for Mega, D10 for
    /// Maple) \param[in] interruptPin The interrupt Pin number that is connected to the RFM DIO0 interrupt line.
    ...
    /// octets copied. \return true if a valid message was copied to buf
